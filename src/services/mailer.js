...
export async function sendMail(to, subject, html, text){ const from = process.env.MAIL_FROM || 'no-reply@khatupay.local'; return getTransporter().sendMail({ from, to, subject, html, text }); }
